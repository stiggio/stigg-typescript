...
const fuse = new Fuse(
  [
    ...
    'client.v1.events.addons.setPricing',
    ...
    'client.v1.events.addons.entitlements.create',
    'client.v1.events.addons.entitlements.delete',
    'client.v1.events.addons.entitlements.list',
    'client.v1.events.addons.entitlements.update',
    'client.v1.events.plans.archive',
    'client.v1.events.plans.create',
    'client.v1.events.plans.list',
    'client.v1.events.plans.publish',
    'client.v1.events.plans.retrieve',
    'client.v1.events.plans.setPricing',
    'client.v1.events.plans.update',
    'client.v1.events.plans.draft.create',
    'client.v1.events.plans.draft.remove',
    'client.v1.events.plans.entitlements.create',
    'client.v1.events.plans.entitlements.delete',
    'client.v1.events.plans.entitlements.list',
    'client.v1.events.plans.entitlements.update',
