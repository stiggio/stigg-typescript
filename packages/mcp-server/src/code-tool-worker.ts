...
const fuse = new Fuse(
  [
    ...
    'client.v1.events.beta.customers.entities.archive',
    'client.v1.events.beta.customers.entities.list',
    'client.v1.events.beta.customers.entities.retrieve',
    'client.v1.events.beta.customers.entities.unarchive',
    'client.v1.events.beta.customers.entities.upsert',
    'client.v1.events.beta.customers.assignments.list',
    'client.v1.events.beta.customers.assignments.upsert',
    'client.v1.events.beta.entityTypes.list',
    'client.v1.events.beta.entityTypes.upsert',
