...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.v1.events.addons.setPricing',
    fullyQualifiedName: 'v1.events.addons.setPricing',
    httpMethod: 'put',
  ...
  {
    clientCallName: 'client.v1.events.addons.entitlements.create',
    fullyQualifiedName: 'v1.events.addons.entitlements.create',
    httpMethod: 'post',
    httpPath: '/api/v1/addons/{addonId}/entitlements',
  },
  {
    clientCallName: 'client.v1.events.addons.entitlements.update',
    fullyQualifiedName: 'v1.events.addons.entitlements.update',
    httpMethod: 'patch',
    httpPath: '/api/v1/addons/{addonId}/entitlements/{id}',
  },
  {
    clientCallName: 'client.v1.events.addons.entitlements.list',
    fullyQualifiedName: 'v1.events.addons.entitlements.list',
    httpMethod: 'get',
    httpPath: '/api/v1/addons/{addonId}/entitlements',
  },
  {
    clientCallName: 'client.v1.events.addons.entitlements.delete',
    fullyQualifiedName: 'v1.events.addons.entitlements.delete',
    httpMethod: 'delete',
    httpPath: '/api/v1/addons/{addonId}/entitlements/{id}',
  },
  {
  ...
  {
    clientCallName: 'client.v1.events.plans.update',
    fullyQualifiedName: 'v1.events.plans.update',
    httpMethod: 'patch',
    httpPath: '/api/v1/plans/{id}',
  },
  {
  ...
  {
    clientCallName: 'client.v1.events.plans.archive',
    fullyQualifiedName: 'v1.events.plans.archive',
    httpMethod: 'post',
    httpPath: '/api/v1/plans/{id}/archive',
  },
  {
    clientCallName: 'client.v1.events.plans.publish',
    fullyQualifiedName: 'v1.events.plans.publish',
    httpMethod: 'post',
    httpPath: '/api/v1/plans/{id}/publish',
  },
  {
    clientCallName: 'client.v1.events.plans.setPricing',
    fullyQualifiedName: 'v1.events.plans.setPricing',
    httpMethod: 'put',
    httpPath: '/api/v1/plans/{id}/charges',
  },
  {
    clientCallName: 'client.v1.events.plans.draft.create',
    fullyQualifiedName: 'v1.events.plans.draft.create',
    httpMethod: 'post',
    httpPath: '/api/v1/plans/{id}/draft',
  },
  {
    clientCallName: 'client.v1.events.plans.draft.remove',
    fullyQualifiedName: 'v1.events.plans.draft.remove',
    httpMethod: 'delete',
    httpPath: '/api/v1/plans/{id}/draft',
  },
  {
    clientCallName: 'client.v1.events.plans.entitlements.create',
    fullyQualifiedName: 'v1.events.plans.entitlements.create',
    httpMethod: 'post',
    httpPath: '/api/v1/plans/{planId}/entitlements',
  },
  {
    clientCallName: 'client.v1.events.plans.entitlements.update',
    fullyQualifiedName: 'v1.events.plans.entitlements.update',
    httpMethod: 'patch',
    httpPath: '/api/v1/plans/{planId}/entitlements/{id}',
  },
  {
    clientCallName: 'client.v1.events.plans.entitlements.list',
    fullyQualifiedName: 'v1.events.plans.entitlements.list',
    httpMethod: 'get',
    httpPath: '/api/v1/plans/{planId}/entitlements',
  },
  {
    clientCallName: 'client.v1.events.plans.entitlements.delete',
    fullyQualifiedName: 'v1.events.plans.entitlements.delete',
    httpMethod: 'delete',
    httpPath: '/api/v1/plans/{planId}/entitlements/{id}',
  },
  {
