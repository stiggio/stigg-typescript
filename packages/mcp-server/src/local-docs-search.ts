...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  {
    name: 'list_contracts',
    endpoint: '/api/v1/customers/{id}/contracts',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) v1.customers > (method) list_contracts',
    qualified: 'client.v1.customers.listContracts',
    params: ['id: string;', 'X-ACCOUNT-ID?: string;', 'X-ENVIRONMENT-ID?: string;'],
    response:
      "{ data: { id: string; activationEndDate: string; activationStartDate: string; billingId: string; contractId: string; createdAt: string; customerExternalId: string; externalId: string; latestInvoice: { billingId: string; createdAt: string; requiresAction: boolean; status: 'OPEN' | 'CANCELED' | 'PAID'; amountDue?: number; billingReason?: string; currency?: string; pdfUrl?: string; total?: number; }; name: string; nextInvoice: { amount: object; dueDate: string; periodEnd: string; periodStart: string; }; poNumber: string; refId: string; state: 'DRAFT' | 'ACTIVE' | 'CANCELED' | 'END_BILLING'; subscriptions: { planDisplayName: string; productDisplayName: string; subscriptionId: string; }[]; }[]; }",
    markdown:
      "## list_contracts\n\n`client.v1.customers.listContracts(id: string, X-ACCOUNT-ID?: string, X-ENVIRONMENT-ID?: string): { data: object[]; }`\n\n**get** `/api/v1/customers/{id}/contracts`\n\nRetrieves a customer's contracts, fetched live from the connected billing provider, each enriched with a preview of its upcoming (next) invoice when available. Returns an empty list when no billing provider is connected or the customer is not synced.\n\n### Parameters\n\n- `id: string`\n\n- `X-ACCOUNT-ID?: string`\n\n- `X-ENVIRONMENT-ID?: string`\n\n### Returns\n\n- `{ data: { id: string; activationEndDate: string; activationStartDate: string; billingId: string; contractId: string; createdAt: string; customerExternalId: string; externalId: string; latestInvoice: { billingId: string; createdAt: string; requiresAction: boolean; status: 'OPEN' | 'CANCELED' | 'PAID'; amountDue?: number; billingReason?: string; currency?: string; pdfUrl?: string; total?: number; }; name: string; nextInvoice: { amount: object; dueDate: string; periodEnd: string; periodStart: string; }; poNumber: string; refId: string; state: 'DRAFT' | 'ACTIVE' | 'CANCELED' | 'END_BILLING'; subscriptions: { planDisplayName: string; productDisplayName: string; subscriptionId: string; }[]; }[]; }`\n  A list of a customer's contracts\n\n  - `data: { id: string; activationEndDate: string; activationStartDate: string; billingId: string; contractId: string; createdAt: string; customerExternalId: string; externalId: string; latestInvoice: { billingId: string; createdAt: string; requiresAction: boolean; status: 'OPEN' | 'CANCELED' | 'PAID'; amountDue?: number; billingReason?: string; currency?: string; pdfUrl?: string; total?: number; }; name: string; nextInvoice: { amount: { amount: number; currency: string; }; dueDate: string; periodEnd: string; periodStart: string; }; poNumber: string; refId: string; state: 'DRAFT' | 'ACTIVE' | 'CANCELED' | 'END_BILLING'; subscriptions: { planDisplayName: string; productDisplayName: string; subscriptionId: string; }[]; }[]`\n\n### Example\n\n```typescript\nimport Stigg from '@stigg/typescript';\n\nconst client = new Stigg();\n\nconst response = await client.v1.customers.listContracts('id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
      ...
      http: {
        example:
          'curl https://api.stigg.io/api/v1/customers/$ID/contracts \\\n    -H "X-API-KEY: $STIGG_API_KEY"',
      },
    },
  },
  {
    name: 'list_invoices',
    endpoint: '/api/v1/customers/{id}/invoices',
    httpMethod: 'get',
    ...
    stainlessPath: '(resource) v1.customers > (method) list_invoices',
    qualified: 'client.v1.customers.listInvoices',
    params: [
      'id: string;',
      'after?: string;',
      'before?: string;',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://api.stigg.io/api/v1/customers/$ID/invoices \\\n    -H "X-API-KEY: $STIGG_API_KEY"',
      },
    },
  },
  {
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1.contracts > (method) list',
    qualified: 'client.v1.contracts.list',
    params: [
      'after?: string;',
      'before?: string;',
      'customerExternalId?: string;',
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://api.stigg.io/api/v1/contracts \\\n    -H "X-API-KEY: $STIGG_API_KEY"',
      },
    },
  },
  {
    ...
    stainlessPath: '(resource) v1.contracts > (method) create',
    qualified: 'client.v1.contracts.create',
    params: [
      'customerId: string;',
    ...
    perLanguage: {
      ...
      http: {
        example:
          'curl https://api.stigg.io/api/v1/contracts \\\n    -H \'Content-Type: application/json\' \\\n    -H "X-API-KEY: $STIGG_API_KEY" \\\n    -d \'{\n          "customerId": "customerId",\n          "subscriptions": [\n            {}\n          ]\n        }\'',
      },
    },
  },
  {
    ...
    stainlessPath: '(resource) v1.contracts > (method) retrieve',
    qualified: 'client.v1.contracts.retrieve',
    params: ['id: string;', 'X-ACCOUNT-ID?: string;', 'X-ENVIRONMENT-ID?: string;'],
    response:
      "{ data: { id: string; activationEndDate: string; activationStartDate: string; billingId: string; contractId: string; createdAt: string; customerExternalId: string; externalId: string; latestInvoice: { billingId: string; createdAt: string; requiresAction: boolean; status: 'OPEN' | 'CANCELED' | 'PAID'; amountDue?: number; billingReason?: string; currency?: string; pdfUrl?: string; total?: number; }; name: string; nextInvoice: { amount: object; dueDate: string; periodEnd: string; periodStart: string; }; poNumber: string; refId: string; state: 'DRAFT' | 'ACTIVE' | 'CANCELED' | 'END_BILLING'; subscriptions: { planDisplayName: string; productDisplayName: string; subscriptionId: string; }[]; }; }",
    markdown:
    ...
    perLanguage: {
      ...
      http: {
        example: 'curl https://api.stigg.io/api/v1/contracts/$ID \\\n    -H "X-API-KEY: $STIGG_API_KEY"',
      },
    },
  },
  {
    ...
    stainlessPath: '(resource) v1.contracts > (method) update',
    qualified: 'client.v1.contracts.update',
    params: [
      'id: string;',
      'activationEndDate?: string;',
      'activationStartDate?: string;',
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'v1.contracts.update',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\ncontract = stigg.v1.contracts.update("x")\n\nputs(contract)',
      },
      cli: {
      ...
      http: {
        example:
          "curl https://api.stigg.io/api/v1/contracts/$ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"X-API-KEY: $STIGG_API_KEY\" \\\n    -d '{}'",
      },
    },
  },
  {
    name: 'delete',
    endpoint: '/api/v1/contracts/{id}/archive',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) v1.contracts > (method) delete',
    qualified: 'client.v1.contracts.delete',
    params: ['id: string;', 'X-ACCOUNT-ID?: string;', 'X-ENVIRONMENT-ID?: string;'],
    response:
      "{ data: { id: string; activationEndDate: string; activationStartDate: string; billingId: string; contractId: string; createdAt: string; customerExternalId: string; externalId: string; latestInvoice: { billingId: string; createdAt: string; requiresAction: boolean; status: 'OPEN' | 'CANCELED' | 'PAID'; amountDue?: number; billingReason?: string; currency?: string; pdfUrl?: string; total?: number; }; name: string; nextInvoice: { amount: object; dueDate: string; periodEnd: string; periodStart: string; }; poNumber: string; refId: string; state: 'DRAFT' | 'ACTIVE' | 'CANCELED' | 'END_BILLING'; subscriptions: { planDisplayName: string; productDisplayName: string; subscriptionId: string; }[]; }; }",
    markdown:
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'v1.contracts.delete',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\ncontract = stigg.v1.contracts.delete("x")\n\nputs(contract)',
      },
      cli: {
      ...
      http: {
        example:
          'curl https://api.stigg.io/api/v1/contracts/$ID/archive \\\n    -X POST \\\n    -H "X-API-KEY: $STIGG_API_KEY"',
      },
    },
  },
  {
