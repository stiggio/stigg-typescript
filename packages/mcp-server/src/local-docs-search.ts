...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1-beta.entities > (method) list',
    qualified: 'client.v1Beta.entities.list',
    params: [
      'id: string;',
      'after?: string;',
      'before?: string;',
    ...
    markdown:
      "## list\n\n`client.v1Beta.entities.list(id: string, after?: string, before?: string, includeArchived?: 'true' | 'false', limit?: number, typeRefId?: string): { id: string; archivedAt: string; createdAt: string; metadata: object; typeId: string; updatedAt: string; }`\n\n**get** `/api/v1-beta/customers/{id}/entities`\n\nRetrieves a paginated list of entities for the given customer.\n\n### Parameters\n\n- `id: string`\n\n- `after?: string`\n  Return items that come after this cursor\n\n- `before?: string`\n  Return items that come before this cursor\n\n- `includeArchived?: 'true' | 'false'`\n  Whether to include archived entities. One of: true, false\n\n- `limit?: number`\n  Maximum number of items to return\n\n- `typeRefId?: string`\n  Filter results to entities of a specific entity type, by the type's refId\n\n### Returns\n\n- `{ id: string; archivedAt: string; createdAt: string; metadata: object; typeId: string; updatedAt: string; }`\n  A stored entity instance tracked by the governance service for a given customer\n\n  - `id: string`\n  - `archivedAt: string`\n  - `createdAt: string`\n  - `metadata: object`\n  - `typeId: string`\n  - `updatedAt: string`\n\n### Example\n\n```typescript\nimport Stigg from '@stigg/typescript';\n\nconst client = new Stigg();\n\n// Automatically fetches more pages as needed.\nfor await (const entityListResponse of client.v1Beta.entities.list('id')) {\n  console.log(entityListResponse);\n}\n```",
    perLanguage: {
      typescript: {
        method: 'client.v1Beta.entities.list',
        example:
          "import Stigg from '@stigg/typescript';\n\nconst client = new Stigg({\n  apiKey: process.env['STIGG_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const entityListResponse of client.v1Beta.entities.list('id')) {\n  console.log(entityListResponse.id);\n}",
      },
      python: {
        method: 'v1_beta.entities.list',
        example:
          'import os\nfrom stigg import Stigg\n\nclient = Stigg(\n    api_key=os.environ.get("STIGG_API_KEY"),  # This is the default and can be omitted\n)\npage = client.v1_beta.entities.list(\n    id="id",\n)\npage = page.data[0]\nprint(page.id)',
      },
      java: {
        method: 'v1Beta().entities().list',
        example:
          'package io.stigg.example;\n\nimport io.stigg.client.StiggClient;\nimport io.stigg.client.okhttp.StiggOkHttpClient;\nimport io.stigg.models.v1beta.entities.EntityListPage;\nimport io.stigg.models.v1beta.entities.EntityListParams;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        StiggClient client = StiggOkHttpClient.fromEnv();\n\n        EntityListPage page = client.v1Beta().entities().list("id");\n    }\n}',
      },
      go: {
        method: 'client.V1Beta.Entities.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stiggio/stigg-go"\n\t"github.com/stiggio/stigg-go/option"\n)\n\nfunc main() {\n\tclient := stigg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.V1Beta.Entities.List(\n\t\tcontext.TODO(),\n\t\t"id",\n\t\tstigg.V1BetaEntityListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      ruby: {
        method: 'v1_beta.entities.list',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\npage = stigg.v1_beta.entities.list("id")\n\nputs(page)',
      },
      cli: {
        method: 'entities list',
        example: "stigg v1-beta:entities list \\\n  --api-key 'My API Key' \\\n  --id id",
      },
      csharp: {
        method: 'V1Beta.Entities.List',
        example:
          'EntityListParams parameters = new() { ID = "id" };\n\nvar page = await client.V1Beta.Entities.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1-beta.entities > (method) upsert',
    qualified: 'client.v1Beta.entities.upsert',
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1-beta.entities > (method) retrieve',
    qualified: 'client.v1Beta.entities.retrieve',
    params: ['id: string;', 'entityId: string;'],
    response:
      '{ data: { id: string; archivedAt: string; createdAt: string; metadata: object; typeId: string; updatedAt: string; }; }',
    markdown:
      "## retrieve\n\n`client.v1Beta.entities.retrieve(id: string, entityId: string): { data: object; }`\n\n**get** `/api/v1-beta/customers/{id}/entities/{entityId}`\n\nRetrieves a single entity for the given customer by its identifier.\n\n### Parameters\n\n- `id: string`\n\n- `entityId: string`\n\n### Returns\n\n- `{ data: { id: string; archivedAt: string; createdAt: string; metadata: object; typeId: string; updatedAt: string; }; }`\n  Response object\n\n  - `data: { id: string; archivedAt: string; createdAt: string; metadata: object; typeId: string; updatedAt: string; }`\n\n### Example\n\n```typescript\nimport Stigg from '@stigg/typescript';\n\nconst client = new Stigg();\n\nconst entity = await client.v1Beta.entities.retrieve('x', { id: 'id' });\n\nconsole.log(entity);\n```",
    perLanguage: {
      typescript: {
        method: 'client.v1Beta.entities.retrieve',
        example:
          "import Stigg from '@stigg/typescript';\n\nconst client = new Stigg({\n  apiKey: process.env['STIGG_API_KEY'], // This is the default and can be omitted\n});\n\nconst entity = await client.v1Beta.entities.retrieve('x', { id: 'id' });\n\nconsole.log(entity.data);",
      },
      python: {
        method: 'v1_beta.entities.retrieve',
        example:
          'import os\nfrom stigg import Stigg\n\nclient = Stigg(\n    api_key=os.environ.get("STIGG_API_KEY"),  # This is the default and can be omitted\n)\nentity = client.v1_beta.entities.retrieve(\n    entity_id="x",\n    id="id",\n)\nprint(entity.data)',
      },
      java: {
        method: 'v1Beta().entities().retrieve',
        example:
          'package io.stigg.example;\n\nimport io.stigg.client.StiggClient;\nimport io.stigg.client.okhttp.StiggOkHttpClient;\nimport io.stigg.models.v1beta.entities.EntityRetrieveParams;\nimport io.stigg.models.v1beta.entities.EntityRetrieveResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        StiggClient client = StiggOkHttpClient.fromEnv();\n\n        EntityRetrieveParams params = EntityRetrieveParams.builder()\n            .id("id")\n            .entityId("x")\n            .build();\n        EntityRetrieveResponse entity = client.v1Beta().entities().retrieve(params);\n    }\n}',
      },
      go: {
        method: 'client.V1Beta.Entities.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stiggio/stigg-go"\n\t"github.com/stiggio/stigg-go/option"\n)\n\nfunc main() {\n\tclient := stigg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tentity, err := client.V1Beta.Entities.Get(\n\t\tcontext.TODO(),\n\t\t"x",\n\t\tstigg.V1BetaEntityGetParams{\n\t\t\tID: "id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", entity.Data)\n}\n',
      },
      ruby: {
        method: 'v1_beta.entities.retrieve',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\nentity = stigg.v1_beta.entities.retrieve("x", id: "id")\n\nputs(entity)',
      },
      cli: {
        method: 'entities retrieve',
        example:
          "stigg v1-beta:entities retrieve \\\n  --api-key 'My API Key' \\\n  --id id \\\n  --entity-id x",
      },
      csharp: {
        method: 'V1Beta.Entities.Retrieve',
        example:
          'EntityRetrieveParams parameters = new()\n{\n    ID = "id",\n    EntityID = "x",\n};\n\nvar entity = await client.V1Beta.Entities.Retrieve(parameters);\n\nConsole.WriteLine(entity);',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1-beta.entities > (method) archive',
    qualified: 'client.v1Beta.entities.archive',
    params: ['id: string;', 'ids: string[];'],
    response: '{ data: { ids: string[]; }; }',
    markdown:
      "## archive\n\n`client.v1Beta.entities.archive(id: string, ids: string[]): { data: object; }`\n\n**post** `/api/v1-beta/customers/{id}/entities/archive`\n\nArchives entities in bulk for the given customer by id.\n\n### Parameters\n\n- `id: string`\n\n- `ids: string[]`\n  Entity identifiers to act on\n\n### Returns\n\n- `{ data: { ids: string[]; }; }`\n  Wrapped response echoing the ids that were acted on by an archive/unarchive call\n\n  - `data: { ids: string[]; }`\n\n### Example\n\n```typescript\nimport Stigg from '@stigg/typescript';\n\nconst client = new Stigg();\n\nconst response = await client.v1Beta.entities.archive('id', { ids: ['user-7f3a0c1d', 'user-c4d1b2e9'] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.v1Beta.entities.archive',
        example:
          "import Stigg from '@stigg/typescript';\n\nconst client = new Stigg({\n  apiKey: process.env['STIGG_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.v1Beta.entities.archive('id', {\n  ids: ['user-7f3a0c1d', 'user-c4d1b2e9'],\n});\n\nconsole.log(response.data);",
      },
      python: {
        method: 'v1_beta.entities.archive',
        example:
          'import os\nfrom stigg import Stigg\n\nclient = Stigg(\n    api_key=os.environ.get("STIGG_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.v1_beta.entities.archive(\n    id="id",\n    ids=["user-7f3a0c1d", "user-c4d1b2e9"],\n)\nprint(response.data)',
      },
      java: {
        method: 'v1Beta().entities().archive',
        example:
          'package io.stigg.example;\n\nimport io.stigg.client.StiggClient;\nimport io.stigg.client.okhttp.StiggOkHttpClient;\nimport io.stigg.models.v1beta.entities.EntityArchiveParams;\nimport io.stigg.models.v1beta.entities.EntityArchiveResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        StiggClient client = StiggOkHttpClient.fromEnv();\n\n        EntityArchiveParams params = EntityArchiveParams.builder()\n            .id("id")\n            .addId("user-7f3a0c1d")\n            .addId("user-c4d1b2e9")\n            .build();\n        EntityArchiveResponse response = client.v1Beta().entities().archive(params);\n    }\n}',
      },
      go: {
        method: 'client.V1Beta.Entities.Archive',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stiggio/stigg-go"\n\t"github.com/stiggio/stigg-go/option"\n)\n\nfunc main() {\n\tclient := stigg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.V1Beta.Entities.Archive(\n\t\tcontext.TODO(),\n\t\t"id",\n\t\tstigg.V1BetaEntityArchiveParams{\n\t\t\tIDs: []string{"user-7f3a0c1d", "user-c4d1b2e9"},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      ruby: {
        method: 'v1_beta.entities.archive',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\nresponse = stigg.v1_beta.entities.archive("id", ids: ["user-7f3a0c1d", "user-c4d1b2e9"])\n\nputs(response)',
      },
      cli: {
        method: 'entities archive',
        example:
          "stigg v1-beta:entities archive \\\n  --api-key 'My API Key' \\\n  --id id \\\n  --id user-7f3a0c1d \\\n  --id user-c4d1b2e9",
      },
      csharp: {
        method: 'V1Beta.Entities.Archive',
        example:
          'EntityArchiveParams parameters = new()\n{\n    ID = "id",\n    Ids =\n    [\n        "user-7f3a0c1d", "user-c4d1b2e9"\n    ],\n};\n\nvar response = await client.V1Beta.Entities.Archive(parameters);\n\nConsole.WriteLine(response);',
      },
      http: {
        example:
  ...
  },
  {
    ...
    stainlessPath: '(resource) v1-beta.entities > (method) unarchive',
    qualified: 'client.v1Beta.entities.unarchive',
    params: ['id: string;', 'ids: string[];'],
    response: '{ data: { ids: string[]; }; }',
    markdown:
      "## unarchive\n\n`client.v1Beta.entities.unarchive(id: string, ids: string[]): { data: object; }`\n\n**post** `/api/v1-beta/customers/{id}/entities/unarchive`\n\nRestores previously archived entities in bulk for the given customer by id.\n\n### Parameters\n\n- `id: string`\n\n- `ids: string[]`\n  Entity identifiers to act on\n\n### Returns\n\n- `{ data: { ids: string[]; }; }`\n  Wrapped response echoing the ids that were acted on by an archive/unarchive call\n\n  - `data: { ids: string[]; }`\n\n### Example\n\n```typescript\nimport Stigg from '@stigg/typescript';\n\nconst client = new Stigg();\n\nconst response = await client.v1Beta.entities.unarchive('id', { ids: ['user-7f3a0c1d', 'user-c4d1b2e9'] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.v1Beta.entities.unarchive',
        example:
          "import Stigg from '@stigg/typescript';\n\nconst client = new Stigg({\n  apiKey: process.env['STIGG_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.v1Beta.entities.unarchive('id', {\n  ids: ['user-7f3a0c1d', 'user-c4d1b2e9'],\n});\n\nconsole.log(response.data);",
      },
      python: {
        method: 'v1_beta.entities.unarchive',
        example:
          'import os\nfrom stigg import Stigg\n\nclient = Stigg(\n    api_key=os.environ.get("STIGG_API_KEY"),  # This is the default and can be omitted\n)\nresponse = client.v1_beta.entities.unarchive(\n    id="id",\n    ids=["user-7f3a0c1d", "user-c4d1b2e9"],\n)\nprint(response.data)',
      },
      java: {
        method: 'v1Beta().entities().unarchive',
        example:
          'package io.stigg.example;\n\nimport io.stigg.client.StiggClient;\nimport io.stigg.client.okhttp.StiggOkHttpClient;\nimport io.stigg.models.v1beta.entities.EntityUnarchiveParams;\nimport io.stigg.models.v1beta.entities.EntityUnarchiveResponse;\n\npublic final class Main {\n    private Main() {}\n\n    public static void main(String[] args) {\n        StiggClient client = StiggOkHttpClient.fromEnv();\n\n        EntityUnarchiveParams params = EntityUnarchiveParams.builder()\n            .id("id")\n            .addId("user-7f3a0c1d")\n            .addId("user-c4d1b2e9")\n            .build();\n        EntityUnarchiveResponse response = client.v1Beta().entities().unarchive(params);\n    }\n}',
      },
      go: {
        method: 'client.V1Beta.Entities.Unarchive',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/stiggio/stigg-go"\n\t"github.com/stiggio/stigg-go/option"\n)\n\nfunc main() {\n\tclient := stigg.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tresponse, err := client.V1Beta.Entities.Unarchive(\n\t\tcontext.TODO(),\n\t\t"id",\n\t\tstigg.V1BetaEntityUnarchiveParams{\n\t\t\tIDs: []string{"user-7f3a0c1d", "user-c4d1b2e9"},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", response.Data)\n}\n',
      },
      ruby: {
        method: 'v1_beta.entities.unarchive',
        example:
          'require "stigg"\n\nstigg = Stigg::Client.new(api_key: "My API Key")\n\nresponse = stigg.v1_beta.entities.unarchive("id", ids: ["user-7f3a0c1d", "user-c4d1b2e9"])\n\nputs(response)',
      },
      cli: {
        method: 'entities unarchive',
        example:
          "stigg v1-beta:entities unarchive \\\n  --api-key 'My API Key' \\\n  --id id \\\n  --id user-7f3a0c1d \\\n  --id user-c4d1b2e9",
      },
      csharp: {
        method: 'V1Beta.Entities.Unarchive',
        example:
          'EntityUnarchiveParams parameters = new()\n{\n    ID = "id",\n    Ids =\n    [\n        "user-7f3a0c1d", "user-c4d1b2e9"\n    ],\n};\n\nvar response = await client.V1Beta.Entities.Unarchive(parameters);\n\nConsole.WriteLine(response);',
      },
      http: {
        example:
