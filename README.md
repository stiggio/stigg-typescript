...
[![NPM version](<https://img.shields.io/npm/v/stigg.svg?label=npm%20(stable)>)](https://npmjs.org/package/stigg) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/stigg)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/stigg-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install stigg`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stigg-typescript/issues) with questions, bugs, or suggestions.
