...
- <code title="post /api/v1/products/{id}/duplicate">client.v1.products.<a href="./src/resources/v1/products.ts">duplicateProduct</a>(id, { ...params }) -> ProductDuplicateProductResponse</code>
