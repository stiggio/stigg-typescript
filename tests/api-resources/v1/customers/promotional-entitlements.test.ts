...
describe('resource promotionalEntitlements', () => {
  ...
  test.skip('grant: only required params', async () => {
    const responsePromise = client.v1.customers.promotionalEntitlements.grant('customerId', {
  ...
  test.skip('revoke: only required params', async () => {
    const responsePromise = client.v1.customers.promotionalEntitlements.revoke('featureId', {
