import fs from 'fs';
import type { ResponseLike } from '@stigg/typescript/internal/to-file';
import { toFile } from '@stigg/typescript/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@stigg/typescript/core/uploads');
    await expect(
