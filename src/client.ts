...
import { V1, V1RetrieveCustomerParams, V1RetrieveCustomerResponse } from './resources/v1/v1';
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STIGG_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STIGG_LOG'] or 'warn' if it isn't set.
   */
...
export class Stigg {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Stigg.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('STIGG_LOG'), "process.env['STIGG_LOG']", this) ??
      defaultLogLevel;
  ...
  static StiggError = Errors.StiggError;
